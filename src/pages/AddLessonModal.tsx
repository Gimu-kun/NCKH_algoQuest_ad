import { Alert, Box, Button, Divider, FormControl, FormHelperText, Grid, IconButton, Input, Snackbar, Stack, TextareaAutosize, Tooltip } from "@mui/material";
...
const AddLessonModal = ({ onClose }: Props) => {
    ...
    return (
        <form onSubmit={handleSubmit} className="bg-white p-5 rounded-xl w-min-1/2 h-9/10 overflow-y-auto">
            ...
            <Divider sx={{ mt: 2, mb: 2, fontSize: 24, fontWeight: 900 }} textAlign="center">Thêm bài học mới</Divider>
